...
def encode_shape(voxel, num_layers=1, id1=None, id2=None, id3=None):
    ...
    for i in range(num_layers):
        ...
        # print('%.3f ' % (np.sum(np.logical_and(voxel.numpy(), decoded.numpy())) / np.sum(np.logical_or(voxel.numpy(), decoded.numpy()))), end='')
        pass
